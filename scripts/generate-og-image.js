...
<svg width="${WIDTH}" height="${HEIGHT}" viewBox="0 0 ${WIDTH} ${HEIGHT}" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <clipPath id="screenshotClip">
      <rect x="700" y="115" width="420" height="265" rx="12" />
    </clipPath>
    <filter id="glow">
  ...
  <!-- Main Title -->
  <text x="70" y="220" font-family="system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif" font-size="52" font-weight="700" fill="white" letter-spacing="-0.5">
    Modern
  </text>
  <text x="70" y="290" font-family="system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif" font-size="52" font-weight="700" fill="white" letter-spacing="-0.5">
    Web <tspan fill="#A855F7">Solutions</tspan>
  </text>

  <!-- Subtitle -->
  <text x="70" y="355" font-family="system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif" font-size="17" font-weight="400" fill="rgba(255,255,255,0.5)" letter-spacing="0.3">
    Web Design • Landing Pages • React Development • SEO
  </text>
  ...
  <!-- Bottom tagline -->
  <text x="70" y="580" font-family="system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif" font-size="12" font-weight="400" fill="rgba(255,255,255,0.2)" letter-spacing="1">
    4MIN.NETLIFY.APP
  </text>
  <text x="70" y="600" font-family="system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif" font-size="12" font-weight="400" fill="rgba(255,255,255,0.2)" letter-spacing="1">
    CRAFTING THE FUTURE
  </text>

  <!-- Bottom right subtle label -->
  <text x="1080" y="600" font-family="system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif" font-size="11" font-weight="500" fill="rgba(124,58,237,0.4)" letter-spacing="1.5" text-anchor="end">
    WEB DEVELOPER
  </text>
</svg>
`;
